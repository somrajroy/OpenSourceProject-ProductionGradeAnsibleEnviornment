...
* The enviornment set-up is now successful. The machines can be shut down from virtual box and restarted anytime later. More complex ansible automation tasks (e.g. patching the different servers automatically) can be performed in this set-up as it mimics a production environment with different linux distros. <br/>
